...
import torchvision
from data.open_set_datasets import get_voc_detection_datasets
...
def main_worker(config):
    ...
    datasets = get_voc_detection_datasets()
    dataloaders = {}
    ...
    OSR_fit(config,model,trainloader,valloader,dataloaders,20,visualization,device)
if __name__ == "__main__":
    import os
    os.environ['KMP_DUPLICATE_LIB_OK'] = 'True'
    cfg = OmegaConf.load("./configs/multi_ood_voc_detection_config.yaml")
    main_worker(cfg)
