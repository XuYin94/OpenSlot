...
from data.osr_natural import Get_Tiny_Dataset,Get_cifar_Dataset
...
def main_worker(config):
    ...
    datasets = Get_Tiny_Dataset(split_idx=1)
    dataloaders = {}
...
if __name__ == "__main__":
    ...
    cfg = OmegaConf.load("configs/single_cifar50_config.yaml")
    main_worker(cfg)
